...
export class Initialt1683671010355 implements MigrationInterface {
    name = 'Initialt1683671010355'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("order_id" SERIAL NOT NULL, "serviceName" character varying NOT NULL, "price" integer NOT NULL, "doctorName" character varying NOT NULL, "patientName" character varying NOT NULL, "amenityId" integer, "doctorId" integer, "patientId" integer, CONSTRAINT "PK_cad55b3cb25b38be94d2ce831db" PRIMARY KEY ("order_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "doctors" ("id" SERIAL NOT NULL, "fullname" character varying NOT NULL, "amenity" character varying NOT NULL, CONSTRAINT "UQ_8207e7889b50ee3695c2b8154ff" UNIQUE ("id"), CONSTRAINT "PK_8207e7889b50ee3695c2b8154ff" PRIMARY KEY ("id"))`);
